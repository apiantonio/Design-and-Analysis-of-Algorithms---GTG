...
class AVLTreeMap(TreeMap):
  ...
  '''Overwrites the class _Node derived from TreeMap._Node by adding:
      - A field that keep the height of the node
      - Some methods to compute the height of left and right subtrees
    Implements _rebalance_insert e _rebalance_delete to allow the rebalancing of the tree'''
  #-------------------------- nested _Node class --------------------------
